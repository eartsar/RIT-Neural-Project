...
def graphNetwork(network,showConnected = True, showMissing = False):
	...
	for weightArg in range(len(inToHid.params)):
		...
		if(inToHid.params[weightArg] != 0):
			if(showConnected):
				plt.plot((inputNodes[nodes[0]][0],hiddenNodes[nodes[1]][0]),(inputNodes[nodes[0]][1],hiddenNodes[nodes[1]][1]),'k-')
		else:
			if(showMissing):
				plt.plot((inputNodes[nodes[0]][0],hiddenNodes[nodes[1]][0]),(inputNodes[nodes[0]][1],hiddenNodes[nodes[1]][1]),'r-')
	...
	for weightArg in range(len(hidToOut.params)):
		...
		if(hidToOut.params[weightArg] != 0):
			if(showConnected):
				plt.plot((hiddenNodes[nodes[0]][0],outputNodes[nodes[1]][0]),(hiddenNodes[nodes[0]][1],outputNodes[nodes[1]][1]),'k-')
		else:
			if(showMissing):
				plt.plot((hiddenNodes[nodes[0]][0],outputNodes[nodes[1]][0]),(hiddenNodes[nodes[0]][1],outputNodes[nodes[1]][1]),'r-')
	...
	for weightArg in range(len(biasToHid.params)):
		...
		if(biasToHid.params[weightArg] != 0):
			if(showConnected):
				plt.plot((biasNodes[nodes[0]][0],hiddenNodes[nodes[1]][0]),(biasNodes[nodes[0]][1],hiddenNodes[nodes[1]][1]),'k-')
		else:
			if(showMissing):
				plt.plot((biasNodes[nodes[0]][0],hiddenNodes[nodes[1]][0]),(biasNodes[nodes[0]][1],hiddenNodes[nodes[1]][1]),'r-')
	...
	for weightArg in range(len(biasToOut.params)):
		...
		if(biasToOut.params[weightArg] != 0):
			if(showConnected):
				plt.plot((biasNodes[nodes[0]][0],outputNodes[nodes[1]][0]),(biasNodes[nodes[0]][1],outputNodes[nodes[1]][1]),'k-')
		else:
			if(showMissing):
				plt.plot((biasNodes[nodes[0]][0],outputNodes[nodes[1]][0]),(biasNodes[nodes[0]][1],outputNodes[nodes[1]][1]),'r-')
